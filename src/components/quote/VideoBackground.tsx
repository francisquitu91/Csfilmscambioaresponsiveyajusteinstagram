    ...
    <>
      <div className={`absolute inset-0 overflow-hidden pointer-events-none transition-opacity duration-1000 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
        <iframe
          ...
          src="https://www.youtube.com/embed/XJhHS6sMeHI?autoplay=1&mute=1&loop=1&playlist=XJhHS6sMeHI&controls=0&showinfo=0&rel=0&iv_load_policy=3&modestbranding=1"
